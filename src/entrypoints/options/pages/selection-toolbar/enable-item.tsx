...
export function EnableItem() {
  ...
  return (
    <ConfigItem
      ...
      title={i18n.t("options.floatingButtonAndToolbar.selectionToolbar.enable.title")}
      description={i18n.t("options.floatingButtonAndToolbar.selectionToolbar.enable.description")}
    >
      <Switch
