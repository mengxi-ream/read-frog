...
const SelectionTranslationPage = lazy(() => import("./pages/selection-translation").then(module => ({ default: module.SelectionTranslationPage })))
...
const ROUTE_COMPONENTS: Record<RoutePath, ComponentType> = {
  ...
  "/selection-translation": SelectionTranslationPage,
