    ...
    <>
      <div className="space-y-2">
        <div className="flex items-start justify-between gap-2">
          <p className={cn("min-w-0 flex-1 text-sm whitespace-pre-wrap break-words [overflow-wrap:anywhere] text-zinc-600 dark:text-zinc-400", !actionsExpanded && "line-clamp-3")}>
            {displayText}
          </p>
          <Button
