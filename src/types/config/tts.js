import { ISO6393_TO_6391, LANG_CODE_ISO6393_OPTIONS, langCodeISO6393Schema, } from "@read-frog/definitions";
import { z } from "zod";
const EDGE_TTS_VOICE_BY_ISO6391 = {
...
export const EDGE_TTS_FALLBACK_VOICE = "en-US-DavisNeural";
export function getDefaultTTSVoiceForLanguage(langCode, fallbackVoice = EDGE_TTS_FALLBACK_VOICE) {
...
export function createDefaultTTSLanguageVoices(fallbackVoice = EDGE_TTS_FALLBACK_VOICE) {
    const entries = LANG_CODE_ISO6393_OPTIONS.map((langCode) => {
        return [langCode, getDefaultTTSVoiceForLanguage(langCode, fallbackVoice)];
    });
...
export const EDGE_TTS_VOICES = [...new Set(EDGE_TTS_VOICE_OPTIONS)]
    .sort((a, b) => a.localeCompare(b));
export function isKnownEdgeTTSVoice(voice) {
