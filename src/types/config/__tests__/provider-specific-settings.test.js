...
describe("provider-specific settings metadata", () => {
    ...
    it("throws when a provider-specific setting lacks providerSettingUi metadata", () => {
        ...
        expect(() => getProviderSpecificSettingFields(schema)).toThrow("providerSpecificSettings.region is missing providerSettingUi metadata");
    });
    it("throws when a provider-specific setting uses an unsupported field type", () => {
        ...
        expect(() => getProviderSpecificSettingFields(schema)).toThrow("Unsupported providerSpecificSettings.region field type: password");
    });
});
