 ...
 *
 * Delta from v100: a top-level `glossary` section holding the enabled switch for
 * the user terminology list. The terms themselves are NOT here — they live in
 * IndexedDB, so no fixture can carry them and no migration touches them. Every
 * existing profile arrives with the shipped defaults.
 */
