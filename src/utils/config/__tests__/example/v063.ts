...
export const testSeries: TestSeriesObject = {
  ...
  "config-with-non-llm-translate-provider": {
    description: "translate.providerId is a non-LLM provider; features get enabled toggles and speak added",
    config: {
      language: {
        sourceCode: "spa",
        targetCode: "eng",
  ...
  "config-with-llm-detection-enabled": {
    description: "LLM detection enabled; features get enabled toggles and speak added",
    config: {
      language: {
        sourceCode: "jpn",
        targetCode: "eng",
  ...
  "config-with-no-default-openai-model": {
    description: "Features get enabled toggles and speak added",
    config: {
      floatingButton: {
        disabledFloatingButtonPatterns: [],
        enabled: true,
