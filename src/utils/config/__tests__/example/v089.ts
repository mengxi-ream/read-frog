...
/**
 * Frozen v089 expectations. Self-contained snapshot (no imports from prior
 * version files). Cohere deprecated models are dropped from the hardcoded list
 * and remapped by the v088 -> v089 migration; fixtures without deprecated
 * Cohere models remain structurally unchanged from v088.
 */
