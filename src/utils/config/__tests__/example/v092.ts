 ...
 *
 * Delta from v091: adds the Edge backend selection and seeds the OpenAI-compatible
 * speech settings while preserving every existing Edge voice preference. Full migration
 * behavior is covered by `migration-scripts/v091-to-v092.test.ts`.
 */
