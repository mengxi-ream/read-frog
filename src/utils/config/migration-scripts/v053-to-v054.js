...
const MIGRATION_V054_KNOWN_EDGE_TTS_VOICES = new Set([
    "af-ZA-AdriNeural",
    "am-ET-AmehaNeural",
    "ar-SA-HamedNeural",
...
const MIGRATION_V054_DEFAULT_LANGUAGE_VOICES = {
    "eng": "en-US-GuyNeural",
...
function isKnownEdgeTTSVoice(voice) {
    return MIGRATION_V054_KNOWN_EDGE_TTS_VOICES.has(voice);
}
function createDefaultTTSLanguageVoices() {
    return {
