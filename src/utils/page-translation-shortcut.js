...
export function isPageTranslationShortcutEmpty(hotkey) {
    return !hotkey?.trim();
}
export function formatPageTranslationShortcut(hotkey, platform) {
...
export function isValidConfiguredPageTranslationShortcut(hotkey, platform = detectPlatform()) {
...
export function normalizePageTranslationShortcut(hotkey, platform = detectPlatform()) {
    if (isPageTranslationShortcutEmpty(hotkey)) {
        return "";
    }
...
export function keyboardEventToPageTranslationShortcut(event, platform = detectPlatform()) {
    const parts = [];
    if (event.ctrlKey) {
        parts.push("Control");
    }
...
function resolveShortcutEventKey(event) {
