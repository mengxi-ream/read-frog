...
let getStorageItemMock;
const { anthropicLanguageModelMock, openRouterLanguageModelMock, openAICompatibleLanguageModelMock, createAnthropicMock, createOpenRouterMock, createOpenAICompatibleMock, } = vi.hoisted(() => {
    ...
    const createAnthropicMock = vi.fn((_options) => ({
        languageModel: anthropicLanguageModelMock,
    }));
    const createOpenRouterMock = vi.fn((_options) => ({
        languageModel: openRouterLanguageModelMock,
    }));
    const createOpenAICompatibleMock = vi.fn((_options) => ({
...
function createAnthropicProviderConfig(headers) {
    return {
...
function createOpenRouterProviderConfig(headers) {
    return {
...
describe("getModelById", () => {
    beforeEach(() => {
        ...
        storage.getItem = getStorageItemMock;
    });
