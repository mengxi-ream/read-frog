...
export function cleanFragmentsForAi(fragments) {
    return fragments
        .map(fragment => ({
        ...fragment,
...
export function formatFragmentsToJson(fragments) {
 ...
 * This is a sentence.
 */
export function parseSimplifiedVttToFragments(vtt) {
    const fragments = [];
 ...
 */
export async function aiSegmentBlock(fragments, config) {
