...
const { buildFeatureUsedEventProperties, getLatencyMs, trackFeatureUsed, } = await import("@/utils/analytics");
describe("analytics helpers", () => {
    ...
    it("tracks feature usage with the expected event payload", async () => {
        ...
        expect(sendMessageMock).toHaveBeenCalledWith("trackFeatureUsedEvent", buildFeatureUsedEventProperties(input));
    });
