...
import { DEFAULT_BATCH_TRANSLATE_PROMPT, DEFAULT_TRANSLATE_PROMPT, DEFAULT_TRANSLATE_SYSTEM_PROMPT, getTokenCellText, INPUT, TARGET_LANGUAGE, WEB_CONTENT, WEB_DESCRIPTION, WEB_SUMMARY, WEB_TITLE, } from "../constants/prompt";
export function resolvePromptReplacementValue(value, fallback) {
    return typeof value === "string" && value.trim() !== "" ? value : fallback;
}
export function getTranslatePromptFromConfig(translateConfig, targetLang, input, options) {
...
export async function getTranslatePrompt(targetLang, input, options) {
