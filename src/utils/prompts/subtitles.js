...
import { DEFAULT_BATCH_TRANSLATE_PROMPT, DEFAULT_SUBTITLE_TRANSLATE_PROMPT, DEFAULT_SUBTITLE_TRANSLATE_SYSTEM_PROMPT, getTokenCellText, SUBTITLE_INPUT, SUBTITLE_TARGET_LANGUAGE, SUBTITLE_WEB_DESCRIPTION, SUBTITLE_WEB_TITLE, VIDEO_SUMMARY, } from "../constants/prompt";
import { resolvePromptReplacementValue } from "./translate";
export async function getSubtitlesTranslatePrompt(targetLang, input, options) {
