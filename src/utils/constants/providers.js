...
export const PROVIDER_ITEMS = {
    ...
    "deeplx": {
        logo: (theme) => theme === "light" ? deeplxLogoLight : deeplxLogoDark,
        name: "DeepLX",
...
export const DEFAULT_PROVIDER_CONFIG_LIST = [
...
export const PURE_TRANSLATE_PROVIDER_ITEMS = pick(TRANSLATE_PROVIDER_ITEMS, PURE_TRANSLATE_PROVIDERS);
...
export const SPECIFIC_TUTORIAL_PROVIDER_TYPES = ["ollama", "deeplx", "deepl"];
