...
export const DEFAULT_DETECTED_CODE = "eng";
export const CONFIG_SCHEMA_VERSION = 79;
export const DEFAULT_FLOATING_BUTTON_POSITION = 0.66;
export const DEFAULT_FLOATING_BUTTON_SIDE = "right";
function createDefaultDictionaryAction() {
...
export const PAGE_TRANSLATE_RANGE_ITEMS = {
    main: { label: "Main" },
    all: { label: "All" },
};
