...
export const DEFAULT_DISPLAY_MODE = "bilingual";
export const DEFAULT_TRANSLATION_POSITION = "above";
export const DEFAULT_CONTROLS_HEIGHT = 60;
export const DEFAULT_SUBTITLE_POSITION = { percent: 10, anchor: "bottom" };
// Subtitle controls sit on top of arbitrary host pages, so keep their theme fixed for readability.
export const SUBTITLES_THEME = "dark";
// Font family mapping
