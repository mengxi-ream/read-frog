...
export const XCOM_STATUS_POLL_INTERVAL_MS = 500
export const XCOM_HLS_DISCOVERY_TIMEOUT_MS = 5000
export const XCOM_HLS_DISCOVERY_POLL_INTERVAL_MS = 500
export const XCOM_FETCH_TIMEOUT_MS = 10_000
export const XCOM_SEGMENT_FETCH_CONCURRENCY = 6
export const XCOM_TRACK_DISCOVERY_CACHE_TTL_MS = 1000
