export const WEB_PAGE_PROMPT_TOKENS = ["targetLanguage", "input", "webTitle", "webDescription", "webContent", "webSummary"];
export const SUBTITLE_PROMPT_TOKENS = ["targetLanguage", "input", "webTitle", "webDescription", "videoSummary"];
...
export const getTokenCellText = (token) => `{{${token}}}`;
