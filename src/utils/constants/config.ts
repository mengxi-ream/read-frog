...
import { DEFAULT_BACKGROUND_FORCE_MERGE, DEFAULT_BACKGROUND_OPACITY, DEFAULT_BACKGROUND_STYLE, DEFAULT_DISPLAY_MODE, DEFAULT_FONT_FAMILY, DEFAULT_FONT_WEIGHT, DEFAULT_LINE_GAP, DEFAULT_MAIN_FONT_SCALE, DEFAULT_MAIN_FONT_SHADOW_INTENSITY, DEFAULT_MAIN_FONT_STROKE_WIDTH, DEFAULT_PRESET_STYLE, DEFAULT_SUBTITLE_COLOR, DEFAULT_SUBTITLE_MODE, DEFAULT_SUBTITLE_POSITION, DEFAULT_TRANSLATION_FONT_SCALE, DEFAULT_TRANSLATION_FONT_SHADOW_INTENSITY, DEFAULT_TRANSLATION_FONT_STROKE_WIDTH, DEFAULT_TRANSLATION_POSITION } from "./subtitles"
