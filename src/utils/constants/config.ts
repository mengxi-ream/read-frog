...
import { DEFAULT_BACKGROUND_OPACITY, DEFAULT_BACKGROUND_STYLE, DEFAULT_DISPLAY_MODE, DEFAULT_FONT_FAMILY, DEFAULT_FONT_WEIGHT, DEFAULT_FORCE_MERGE_BACKGROUND, DEFAULT_LINE_GAP, DEFAULT_MAIN_FONT_SCALE, DEFAULT_MAIN_FONT_SHADOW_INTENSITY, DEFAULT_MAIN_FONT_STROKE_WIDTH, DEFAULT_SUBTITLE_COLOR, DEFAULT_SUBTITLE_POSITION, DEFAULT_TRANSLATION_FONT_SCALE, DEFAULT_TRANSLATION_FONT_SHADOW_INTENSITY, DEFAULT_TRANSLATION_FONT_STROKE_WIDTH, DEFAULT_TRANSLATION_POSITION } from "./subtitles"
...
export const DEFAULT_CONFIG: Config = {
  ...
  videoSubtitles: {
    ...
    style: {
      ...
      forceMergeBackground: DEFAULT_FORCE_MERGE_BACKGROUND,
      main: {
        fontFamily: DEFAULT_FONT_FAMILY,
        fontScale: DEFAULT_MAIN_FONT_SCALE,
        color: DEFAULT_SUBTITLE_COLOR,
        fontWeight: DEFAULT_FONT_WEIGHT,
        fontShadowIntensity: DEFAULT_MAIN_FONT_SHADOW_INTENSITY,
        fontStrokeWidth: DEFAULT_MAIN_FONT_STROKE_WIDTH,
      },
      translation: {
        fontFamily: DEFAULT_FONT_FAMILY,
        fontScale: DEFAULT_TRANSLATION_FONT_SCALE,
        color: DEFAULT_SUBTITLE_COLOR,
        fontWeight: DEFAULT_FONT_WEIGHT,
        fontShadowIntensity: DEFAULT_TRANSLATION_FONT_SHADOW_INTENSITY,
        fontStrokeWidth: DEFAULT_TRANSLATION_FONT_STROKE_WIDTH,
      },
      container: {
