...
import { DEFAULT_AUTO_TRANSLATE_SHORTCUT_KEY, DEFAULT_BATCH_CONFIG, DEFAULT_MIN_CHARACTERS_PER_NODE, DEFAULT_MIN_WORDS_PER_NODE, DEFAULT_PRELOAD_MARGIN, DEFAULT_PRELOAD_THRESHOLD, DEFAULT_REQUEST_CAPACITY, DEFAULT_REQUEST_RATE, DEFAULT_SPLIT_TRANSLATOR_SHORTCUT_KEY } from "./translate"
...
export const DEFAULT_CONFIG: Config = {
  ...
  translate: {
    ...
    splitTranslator: {
      shortcut: DEFAULT_SPLIT_TRANSLATOR_SHORTCUT_KEY,
    },
