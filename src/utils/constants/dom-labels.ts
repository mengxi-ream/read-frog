...
export const RETRANSLATE_ATTRIBUTE = "data-read-frog-retranslate"

export const MARK_ATTRIBUTES = new Set([WALKED_ATTRIBUTE, PARAGRAPH_ATTRIBUTE, BLOCK_ATTRIBUTE, INLINE_ATTRIBUTE, RETRANSLATE_ATTRIBUTE])
