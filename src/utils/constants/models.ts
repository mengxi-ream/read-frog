...
export const LLM_PROVIDER_MODELS = {
  ...
  "anthropic": ["claude-opus-4-8", "claude-opus-4-7", "claude-opus-4-6", "claude-sonnet-4-6", "claude-opus-4-5", "claude-haiku-4-5", "claude-sonnet-4-5", "claude-opus-4-1", "claude-opus-4-0", "claude-sonnet-4-0"],
...
const OPENAI_GPT5_REASONING_EFFORT_POLICIES: OpenAIGPT5ReasoningEffortPolicy[] = [
  ...
  {
    pattern: /^(?:gpt-5\.5|gpt-5\.4|gpt-5\.4-mini|gpt-5\.4-nano)$/,
...
export const LLM_MODEL_OPTIONS: Array<{
  ...
  {
    pattern: /^grok-(?:4\.20-reasoning|4(?:-fast-reasoning|-latest|-0709)?|4-1|3(?:-mini)?(?:-latest)?|code-fast-1)$/,
