...
const resolvedAssetBlobCache = new Map();
const pendingAssetBlobCache = new Map();
...
export function shouldProxyAssetUrl(resourceUrl, pageUrl = getCurrentPageUrl()) {
...
export async function resolveContentScriptAssetBlob(resourceUrl) {
