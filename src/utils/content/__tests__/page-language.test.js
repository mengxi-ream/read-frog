...
describe("detectPageLanguageLightweight", () => {
    ...
    it("prefers Chinese text detection over conflicting English metadata", async () => {
        ...
        expect(mockDetectLanguageWithSource).toHaveBeenCalledWith(expect.stringContaining("阅读 - 源仓库"), { enableLLM: false });
    });
    ...
    `;
        ...
        expect(mockDetectLanguageWithSource).toHaveBeenCalledWith(expect.stringContaining("A useful article title"), { enableLLM: false });
