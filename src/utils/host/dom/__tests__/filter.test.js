...
import { isDontWalkIntoAndDontTranslateAsChildElement, isDontWalkIntoButTranslateAsChildElement, isShallowBlockHTMLElement, isShallowInlineHTMLElement, isTranslatedContentNode, } from "../filter";
...
function createConfig(range) {
    return { translate: { page: { range } } };
}
