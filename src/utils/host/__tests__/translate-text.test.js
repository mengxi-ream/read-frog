...
let mockSendMessage;
let mockMicrosoftTranslate;
let mockGoogleTranslate;
let mockGetConfigFromStorage;
let mockGetTranslatePrompt;
let mockGetOrCreateWebPageContext;
let mockGetOrGenerateWebPageSummary;
let mockDetectLanguage;
