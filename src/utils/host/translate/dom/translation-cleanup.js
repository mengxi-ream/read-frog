...
export function removeShadowHostInTranslatedWrapper(wrapper) {
 ...
 */
export function removeTranslatedWrapperWithRestore(wrapper) {
...
export function removeAllTranslatedWrapperNodes(root = document) {
