 ...
 */
export function createLightweightSpinner(ownerDoc) {
...
export function createSpinnerInside(translatedWrapperNode) {
...
export async function getTranslatedTextAndRemoveSpinner(nodes, textContent, spinner, translatedWrapperNode) {
    let translatedText;
    try {
