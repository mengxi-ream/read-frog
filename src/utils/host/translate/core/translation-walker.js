import { BLOCK_ATTRIBUTE, CONTENT_WRAPPER_CLASS, PARAGRAPH_ATTRIBUTE, WALKED_ATTRIBUTE, } from "../../../constants/dom-labels";
import { isBlockTransNode, isHTMLElement, isTextNode, isTransNode } from "../../dom/filter";
import { translateNodes } from "./translation-modes";
export async function translateWalkedElement(element, walkId, config, toggle = false) {
