export function addStyleToShadow(shadow) {
...
function isInternalStyleElement(node) {
    if (!node)
        return false;
 ...
 */
export function mirrorDynamicStyles(selector, shadowRoot, contentMatch) {
    ...
    const updateStyles = (textContent) => {
