...
interface ProtocolMap {
  ...
  toggleSidePanel: (data?: { source?: "content-script" | "extension-user-action", windowId?: number }) => Promise<{ ok: true, action: "opened" | "closed" } | { ok: false, reason: "missing-window" | "unsupported" | "toggle-failed" | "requires-extension-user-action" }>
  // config
