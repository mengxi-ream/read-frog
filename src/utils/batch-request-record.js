...
export async function getRangeBatchRequestRecords(startDay, endDay) {
...
export async function putBatchRequestRecord({ originalRequestCount, providerConfig }) {
...
export function calculateAverageSavePercentage(batchRequestRecords) {
