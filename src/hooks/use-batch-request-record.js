    ...
    const previousPeriodQueries = useQueries({
        queries: RECENT_DAYS.map((dayRange) => {
            ...
            return {
                ...
                queryFn: () => getRangeBatchRequestRecords(previousPeriodStartDay(daysBack), previousPeriodEndDay(daysBack)),
            };
        }),
    });
