...
export function RetryButton({ nodes }) {
    ...
    return (_jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { render: (_jsx("button", { type: "button", onClick: handleRetry })), children: _jsx(IconReload, { className: "size-4 text-blue-500 hover:text-blue-600 dark:hover:text-blue-400" }) }), _jsx(TooltipContent, { container: shadowWrapper, side: "bottom", className: "notranslate", children: "Retry translation" })] }));
}
