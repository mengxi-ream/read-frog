...
import { z } from "zod";
import { createExtensionClientEnvSchema, LOCAL_EXTENSION_ENV_DEFAULTS, PRODUCTION_EXTENSION_ENV_DEFAULTS, resolveExtensionEnv, } from "../shared";
...
function parseResolvedExtensionEnv(rawEnv, isProd = false, skipRequiredProductionEnv = false) {
